...
import timeByDateParameters from "./components/timeByDateParameters";
import timeByDateRangeTable from "./components/timeByDateRangeTable";
          ...
          <div className="row">
            <div className="col-md-12">
              <Switch>
                ...
                <Route
                  exact
                  path="/timeByDateParameters"
                  component={timeByDateParameters}
                />
                <Route
                  exact
                  path="/timeByDateTable"
                  component={timeByDateTable}
                />
                <Route
                  exact
                  path="/timeByDateRangeTable"
                  component={timeByDateRangeTable}
                />
